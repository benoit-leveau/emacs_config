...
;; Deux espaces ‡ la fin des phrases en anglais.
;;(setq sentence-end "[.?!][]\"')]*\\($\\| $\\|\t\\|  \\)[ \t\n]*")
;;(setq sentence-end-double-space t)

;; Une espace ‡ la fin des phrases en franÁais.
(setq sentence-end "[.?!][]\"')]*\\($\\|\t\\| \\)[ \t\n]*")
...
;; fonction qui indente la ligne sur laquelle on √©tait et la suivante
;; quand on appuie sur entr√©e (en mode c c++)
(defun newline2()
  (interactive)
