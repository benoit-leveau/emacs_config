...
(defcustom random-idle-quotes
  '("Remove trailing whitespace with M-k (delete-trailing-whitespace)"
    "C-x r s X sets the register X"
    "C-x r g X gets the register X"
    "M-x lgrep grep-find wizard (with default on current dir and current word)"
    "Dvorak Mid: aoeui dhtns"
    "Dvorak Top: py fgcrl"
    "Dvorak Bot: qjkx bmwvz"
	"M-x prepare-file will call 'tabify', 'delete-trailing-whitespace' and 'save-buffer'. Useful before commiting!"
